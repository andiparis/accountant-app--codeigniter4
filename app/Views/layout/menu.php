...
<?php if (in_groups(['admin'])) { ?>
  <li><a href="<?= site_url('akun2') ?>" class="nav-link"><i class="fas fa-fire"></i><span>Kode Akun</span></a></li>
<?php } ?>
...
<?php if (in_groups(['admin'])) { ?>
  <li><a class="nav-link" href="<?= site_url('posting') ?>"><i class="fas fa-beer"></i><span>Buku Besar</span></a></li>
<?php } ?>
