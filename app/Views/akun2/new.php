...
<?= $this->section('title') ?>
<title>SIA &mdash; Add Akun 2</title>
<?= $this->endSection() ?>
      ...
      <div class="card-body p-4">
        <form action="<?= site_url('akun2') ?>" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" name="kode_akun2" id="kode_akun2" placeholder="Kode akun 2" class="form-control" required>
          </div>
          <div class="form-group">
            <label for="nama_akun2">Nama Akun 2</label>
            <input type="text" name="nama_akun2" id="nama_akun2" placeholder="Nama akun 2" class="form-control" required>
          </div>
          <div class="form-group">
